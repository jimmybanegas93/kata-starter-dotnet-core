...
namespace Kata.Spec
{
    ...
    public class when_user_input_has_an_unknown_amount_of_numbers
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("3,4,5"); };

        It should_return_the_sum_of_all_those_numbers = () => { _result.Should().Be(12); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_useR_input_has_one_negative_number
    {
        ...
        It should_return_an_exception_with_message = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_has_numbers_larger_than_1000
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("1001,2"); };

        It should_only_sum_numbers_less_than_1000 = () => { _result.Should().Be(2); };
        static Calculator _systemUnderTest;
        static int _result;
    }
}
